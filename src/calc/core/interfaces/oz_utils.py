...
def request_fill_item_params(
    ...
    """
    return oz_calcdata.OzLogItemParams(
...
def request_fill_return_params(
    ...
    """
    return oz_calcdata.OzReturnsParams(
